...
| 🩹 Horas de absentismo analizadas | 👥 Empleados | ⚠️ Riesgo x antecedentes disciplinarios | 📚 Barrera nº1 a la formación |
|:---:|:---:|:---:|:---:|
| **5.043 h** | **136** | **× 5,5** | **55 %** |
...
Cada sprint parte de la conclusión del anterior — es una evolución real del análisis, no cuatro entregas independientes: de **describir** el absentismo (S1), a **predecir** quién tiene riesgo (S2), a **prevenir** con acciones de coste estimado (S3), hasta **abrir el foco** a políticas de formación con datos sectoriales externos (S4).
...
│   ├── 📽️ BusinessReport-_2026-06-29/07-06/07-13.pptx
│   ├── 📽️ BusinessReport-_2026-07-27.pptx          ⭐ Proyecto final
...
### 1️⃣ Sprint 1 (29/06) — Magnitud del absentismo
- **5.043 horas totales** de absentismo · **152,8 h de media por empleado**
- 🔺 Tres empleados concentran **más del 25%** del total de horas
- 📅 Pico mensual en **marzo** (755 h) · motivo más frecuente: **consultas médicas** (142 ausencias)
- ✅ El **93,90%** de las ausencias solicitadas se materializan

### 2️⃣ Sprint 2 (06/07) — ¿Quién tiene riesgo de absentismo elevado?
- Agregación de ~800 registros → **136 empleados**, para no romper la independencia de las observaciones
- 🧮 Regresión logística binaria sobre `Absentismo_Alto`
- 💡 **Hallazgo clave:** sin correlación con atributos personales — la única relación real es con la **gestión de la carga de trabajo**
- 🎯 Propuestas estructuradas en 3 palancas: selección · capacitación · retención

### 3️⃣ Sprint 3 (13/07) — Perfiles de riesgo y KPIs de desempeño
- Absentismo recodificado en **4 niveles ordinales** (Bajo/Medio/Alto/Severo)
- ⚠️ Antecedentes disciplinarios → **× 5,5 la probabilidad** de absentismo elevado
- 🔥 El nivel "Severo" concentra el **67% de las jornadas perdidas**
- 📐 KPI de desempeño compuesto (8 indicadores, z-scores ponderados): la **carga de trabajo** es el único predictor robusto y negativo en los 8 KPIs (Spearman −0,10 a −0,13)
- 3 acciones preventivas priorizadas, cada una con coste estimado (desde ~20-30 entrevistas/año hasta formación in-company de 3.000-6.000 €)

---

## 📚 Sprint 4 (proyecto final) · Tendencias formativas del sector
...
**Fuente de datos:** Encuesta Anual Laboral (EAL), Ministerio de Trabajo y Economía Social, 2022-2024 — foco en empresas de **+499 trabajadores**.
...
|---|:---:|---|
| 🧠 Competencias | compañero/a | Técnicas del puesto (45%), atención al cliente (31,5%) y trabajo en equipo (30,1%) lideran la oferta formativa 2024 |
| 🎓 Medios | compañero/a | Cursos externos (79,7%) y formación en el puesto (52%) dominan sobre conferencias/rotación |
| 🚧 **Barreras** | **yo** | **Carga de trabajo/falta de tiempo (55%)** y **percepción de nivel ya adecuado (53%)** — únicas barreras >50%. Test Z por tramos (2022→23, 2023→24): **6 de 16 cambios año a año son fiables**; solo la falta de oferta formativa muestra tendencia creciente sostenida |
...
flowchart LR
    ...
    D --> E[📽️ Business Report<br/>+ Power BI]
```
