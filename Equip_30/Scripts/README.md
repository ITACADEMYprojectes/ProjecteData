...
├── 05-25-2026/ 
    ...
    2. 05-25-2026_Analysis-EDA.ipynb
    3. 05-25-2026_Clean-Data.ipynb
    ...
    - *Función:* Carga los datos sin procesar, verifica su integridad y los guarda en `Data/05-25-2026`. Usa el archivo '05-25-2026_Config-User.json' para connectar a la base de datos.
        ...
        1.1. **05-25-2026_Config-User.json**
...
├── 06-01-2026/ 
    ...
    2. 06-01-2026_Clean-Data.ipynb
    3. 06-01-2026_Analysis-Marketing.ipynb
    4. 06-01-2026_Analysis-Client-Profile.ipynb
    5. 06-01-2026_Analysis-Finance-Credit-Risk.ipynb
    ...
    2. **06-01-2026_Clean-Data.ipynb**
    - *Función:* Procesa los datos faltantes, los valores atípicos y las categorías de códigos. Guarda los datos limpios en `Data/06-01-2026`.
